...
## Resources
- Data Source: [crypto_data.csv](https://github.com/skaram16/cryptocurrencies/blob/main/Resources/crypto_data.csv)
- Software: Python 3.7.7, Visual Studio Code, Jupyter Notebook 6.0.3
<br><br>
...
The best k value appears to be 4, therefore I would conclude that an output of 4 clusters to categorize the crytocurrencies.
<br><br>
...
<br><br>
Both of these scatter plots show the distribution and the four clusters of cryptocurrencies.<br>
...
Particularities of each group need to be analyzed further to determine their performance and potential interest for the investment bank's clients.
